...
function LearnNav (){
  return(
    <div className="space-y-2 flex flex-col text-black gap-5">
        ...
        <Link to="/tools" className="flex p-2 hover:bg-gray-100 rounded gap-1">
        {/* <MonetizationOn /> */}
        <HiChartPie style={{width:28, height:28}} />
          Tools
        </Link>
        <Link to="/events" className="flex p-2 hover:bg-gray-100 rounded gap-1">
        {/* <Article /> */}
        <BiSolidCalendarEvent style={{width:28, height:28}} />
          Events
        </Link>
        <Link to="/library" className="flex p-2 hover:bg-gray-100 rounded gap-1">
        {/* <Article /> */}
  ...
  return (
    <nav id="navigation" className="fixed left-0 top-0 h-screen w-57 shadow-lg p-4 flex flex-col gap-10 bg-white text-[#5D5D5D]">
      ...
      <Link to="/wealthview" className="flex p-2 hover:bg-gray-100 rounded gap-1">
        ...
        <Link to="/support" className="flex p-2 hover:bg-gray-100 rounded gap-1">
        {/* <Support /> */}
