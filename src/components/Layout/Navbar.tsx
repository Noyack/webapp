  ...
  return (
    <nav id="navigation" className="fixed left-0 top-0 h-screen w-57 shadow-lg p-4 flex flex-col gap-10 bg-white text-[#5D5D5D]">
      ...
      <div className="space-y-2 flex flex-col text-black gap-5">
        ...
        <Link to="/community" className="flex p-2 hover:bg-gray-100 rounded gap-1">
        {/* <People /> */}
        <RiUserCommunityFill style={{width:28, height:28}} />
          Community
        </Link>
        ...
        <Link to="/planning" className="flex p-2 hover:bg-gray-100 rounded gap-1">
        {/* <MonetizationOn /> */}
        <HiChartPie style={{width:28, height:28}} />
          Planning
        </Link>
        <Link to="/bookmark" className="flex p-2 hover:bg-gray-100 rounded gap-1">
        {/* <Article /> */}
        <FaBookmark style={{width:28, height:28}} />
          Bookmark
        </Link>
